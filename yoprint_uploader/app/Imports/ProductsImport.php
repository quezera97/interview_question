...
class ProductsImport implements OnEachRow, WithHeadingRow, WithChunkReading, ShouldQueue, WithEvents
{
    ...
    // maatwebsite already did the encoding
    function checkEncType($value)
    {
        return mb_detect_encoding($value, ['UTF-8', 'ISO-8859-1', 'Windows-1252'], true);
    }

    private function cleanNonUTF8Char($value)
    {
        return mb_convert_encoding($value, 'UTF-8', $this->checkEncType($value));
    }
